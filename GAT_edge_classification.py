...
def train(wandb_config, mod_game_root_dir = None, sol_root_dir = None, output_wt_file=None):
    ...
    if output_wt_file == None: 
        output_wt_file = os.path.join(os.getcwd(),'GATConv_2_class_weights.pth')
...
def predict(wandb_config, weights =None, mod_game_file_root = None):
    ...
    if weights == None: 
        weights = os.path.join(os.getcwd(),'GATConv_2_class_weights.pth')
    if mod_game_file_root == None: 
        mod_game_file_root = os.path.join(os.getcwd(),'games-small/Three_class_mod_games_test')
...
class Evaluator:
    ...
    def evaluate(self, original_game_file_root = None, prediction_results_file=None, ref_sol_root = None, output_file_location=None):
        ...
        if original_game_file_root == None: 
            original_game_file_root = os.path.join(os.getcwd(), 'games-small/Three_class_mod_games_test')
        ...
        if ref_sol_root == None: 
            ref_sol_root = os.path.join(os.getcwd(), 'games-small/mod_games_test/sol')
