...
class ModifyGameData:
    ...
    def read_dataset( input_file_path = None):
        ...
        if input_file_path == None:
            ...
            input_file_path = os.path.join(os.getcwd(),'games-small/Phase2_train_data.csv')
        try: 
    ...
    *                           files
    ...
    def modify_game_for_3_class(mod_games_root=None, sol_root=None):
        ...
        if mod_games_root == None:
            mod_games_root = os.path.join(os.getcwd(), "games-small/mod_games_test/mod_games")
        if sol_root == None: 
            sol_root = os.path.join(os.getcwd(), "games-small/mod_games_test/sol")
        ...
        try: 
            ...
            new_dir = os.mkdir(os.path.join( (os.path.join(os.getcwd(), 'games-small')), "Three_class_mod_games_test"))
        
        except: 
            new_dir = os.path.join( (os.path.join(os.getcwd(), 'games-small')), "Three_class_mod_games_test")
...
def main(): 
    ...
    #input_file_path = ModifyGameData.pre_process_predict_results(os.path.join(os.getcwd(),'games-small/Phase2_train_data.csv'))
    #ModifyGameData.modify_game_file(results= ModifyGameData.read_dataset(os.path.join(os.getcwd(),'games-small/Phase2_train_data.csv')), output_file_location='/home/muth_sw/Desktop/GNNPG/games-small/mod_games_test/mod_games' )
    #ModifyGameData.pre_process_train_dataset('/home/muth_sw/Desktop/GNNPG/games-small/mod_games_test/Test_set_unmod', '/home/muth_sw/Desktop/GNNPG/games-small/mod_games_test/sol', '/home/muth_sw/Desktop/GNNPG/games-small')
